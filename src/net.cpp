...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "coinempzclassic " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"n0.net","138.197.27.148"},
    {"n1.net","107.170.117.243"},
    {"n2.net","107.170.156.17"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. coinempzclassic is probably already running."), addrBind.ToString().c_str());
        else
